                    ...
                    return (
                        ...
                        (t.prototype.applyStyles = function (e, n) {
                            ...
                            if ((e.font && (s = e.font), e.fontStyle)) {
                                ...
                                u &&
                                    -1 === u.indexOf(a) &&
                                    (this.jsPDFDocument.setFontStyle && this.jsPDFDocument.setFontStyle(u[0]),
                                    (a = u[0]));
                            }
                            if (
        ...
        function (t, e, n) {
            ...
            function i(t, e, n, i, a, s) {
                for (var u = new r.HtmlRowInput(i), d = 0; d < i.cells.length; d++) {
                    ...
                    if (a || 'none' !== h.display) {
                        var f = void 0;
                        s && (f = o.parseCss(t, c, e, h, n)),
                            u.push({ rowSpan: c.rowSpan, colSpan: c.colSpan, styles: f, _element: c, content: l(c) });
                    }
                }
            ...
            e.parseHtml = function (t, e, n, o, r) {
                ...
                if (!s)
                    return (
                        console.error('Html table could not be found with input: ', e), { head: c, body: h, foot: f }
                    );
                for (var p = 0; p < s.rows.length; p++) {
                    var g = s.rows[p],
                        y =
                            null ===
                                (a =
                                    null === (l = null == g ? void 0 : g.parentElement) || void 0 === l
                                        ? void 0
                                        : l.tagName) || void 0 === a
                                ? void 0
                                : a.toLowerCase(),
                            ...
                            if (o.canEntireRowFit(h, n.columns)) d(e, n, o, s);
                                ...
                                (function (t, e, n, o) {
                                    var r = t.pageSize().height,
                                        ...
                                        a = r - l;
                                    'body' === e.section &&
                                        (a -= o.getHeadHeight(o.columns) + o.getFootHeight(o.columns));
                                ...
                                var f = (function (t, e, n, o) {
                                    ...
                                    for (var l = 0, s = 0, d = n.columns; s < d.length; s++) {
                                        ...
                                        if ((m = t.cells[c.index])) {
                                            ...
                                            (m.contentHeight = m.getContentHeight(p)),
                                                m.contentHeight >= e &&
                                                    ((m.contentHeight = e), (h.styles.minCellHeight -= e)),
                                                m.contentHeight > t.height && (t.height = m.contentHeight),
                                                (h.contentHeight = h.getContentHeight(p)),
                                                h.contentHeight > l && (l = h.contentHeight),
                                                (r[c.index] = h);
                                        }
                                    }
                                    ...
                                    for (var y = 0, v = n.columns; y < v.length; y++) {
                                        var m;
                                        c = v[y];
                                        (h = g.cells[c.index]) && (h.height = g.height),
                                            (m = t.cells[c.index]) && (m.height = t.height);
                                    }
                                    return g;
                                })(o, h, n, e);
                ...
                return (
                    (t.prototype.getMaxCellHeight = function (t) {
                        ...
                        return t.reduce(function (t, n) {
                            ...
                            return Math.max(
                                t,
                                (null === (o = e.cells[n.index]) || void 0 === o ? void 0 : o.height) || 0
                            );
                        }, 0);
                    }),
                ...
                function t(t, e, n) {
                    ...
                    null == t || 'object' != typeof t || Array.isArray(t)
                        ...
                        : ((this.rowSpan = t.rowSpan || 1),
                          ...
                          (i =
                              null !== (r = null !== (o = t.content) && void 0 !== o ? o : t.title) && void 0 !== r
                                  ? r
                                  : t),
                    ...
                    for (var u = 0, c = {}, h = 0, f = 0, p = 0, g = n; p < g.length; p++) {
                        ...
                        if (null == a[y.index] || 0 === a[y.index].left)
                            if (0 === f) {
                                var v = void 0,
                                    m = {};
                                'object' != typeof (v = Array.isArray(e) ? e[y.index - h - u] : e[y.dataKey]) ||
                                    Array.isArray(v) ||
        ...
        function (t, e, n) {
            ...
            function r(t, e) {
                var n = (function t(e, n) {
                    var o = n(e);
                    return 'rgba(0, 0, 0, 0)' === o || 'transparent' === o || 'initial' === o || 'inherit' === o
            ...
            e.parseCss = function (t, e, n, i, l) {
                ...
                -1 !== c.indexOf(i.textAlign) && (a.halign = i.textAlign),
                    -1 !== (c = ['middle', 'bottom', 'top']).indexOf(i.verticalAlign) && (a.valign = i.verticalAlign);
                var h = parseInt(i.fontSize || '');
                isNaN(h) || (a.fontSize = h / (96 / 72));
                var f = (function (t) {
                    var e = '';
                    ('bold' === t.fontWeight || 'bolder' === t.fontWeight || parseInt(t.fontWeight) >= 700) &&
                        (e = 'bold');
                    ...
                    for (
                        var i = function (e) {
                                e &&
                                    ...
                                    ['createdHeaderCell', 'drawHeaderRow', 'drawRow', 'drawHeaderCell'].forEach(
                                        function (t) {
                                            e[t] &&
                                                console.error(
                                                    'The "' +
                                    ...
                                    [
                                        ...
                                        var n = t[0],
                                            o = t[1];
                                        e[o] &&
                                            (console.error('Use of deprecated option ' + o + '. Use ' + n + ' instead'),
                                            (e[n] = e[o]));
                                    }),
                                    [
                                        ['padding', 'cellPadding'],
                                        ...
                                        void 0 !== e[n] &&
                                            ...
                                            console.error(
                                                'Use of deprecated option: ' + n + ', use the style ' + o + ' instead.'
                                            ));
                                    });
                                for (
                                    var n = 0, r = ['styles', 'bodyStyles', 'headStyles', 'footStyles'];
                                    n < r.length;
                                    n++
                                ) {
                                    o(e[r[n]] || {});
            ...
            (e.calculateWidths = function (t, e) {
                    ...
                    e.allRows().forEach(function (r) {
                        for (var i = 0, l = e.columns; i < l.length; i++) {
                            ...
                            if (s) {
                                ...
                                if (
                                    ((s.minReadableWidth = c + s.padding('horizontal')),
                                    ...
                                    (s.minWidth = s.contentWidth), (s.wrappedWidth = s.contentWidth);
                                else {
                                    var h = 10 / n;
                                    (s.minWidth = s.styles.minCellWidth || h),
                ...
                a &&
                    ...
                    (a = Math.abs(a)) > 0.1 / t.scaleFactor() &&
                        ...
                        console.error('Of the table content, ' + a + ' units width could not fit page')),
                    (function (t) {
